<template>
    <div class="tan-input-number">
        <span class="tan-input-number-btn" :class="{ 'disable': minDisable }" @click="decrease">-</span>
        <input type="number" class="tan-input-number-value" :value="number" @change="handleInputChange($event.target.value)" ref="input">
        <span class="tan-input-number-btn" :class="{ 'disable': maxDisable }" @click="increase">+</span>
    </div>
</template>
