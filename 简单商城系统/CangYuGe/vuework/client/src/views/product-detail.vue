        ...
        <div class="product-detail">
            <div class="body container">
                ...
                <div class="info">
                    ...
                    <div class="btns">
                        <tan-button primary width="298px" height="52px" font-size="16px" @click="buy">立即购买</tan-button>
                        <tan-button gray width="140px" height="52px" font-size="16px" @click="addCart">加入购物车</tan-button>
                    </div>
                </div>
            </div>
        </div>
        <tan-product-list class="container" :products="products" :title="product.category[0].name"></tan-product-list>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        loadProductCategoryById(id) {
            productHttp.listByCategoryId(id)
                .then( resp => {
